...
public class DBConstants {
    ...
    public static final String GET_ALL_TICKET = "select * FROM ticket";
    public static final String COUNT_REG_NUMBER = "select count(VEHICLE_REG_NUMBER) from ticket where VEHICLE_REG_NUMBER = ?";
}
